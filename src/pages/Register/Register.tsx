  ...
  return (
    <>
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 4xl:grid-cols-[minmax(0,_1030px)_minmax(0,_1fr)]">
        {width >= 1024 && (
          <div className="border border-black flex flex-col justify-center items-center lg:p-[60px]">
            <div>
              <img src={Visa} alt="Visa" />
            </div>
          </div>
        )}
        <div className="border border-black flex items-center justify-center w-full py-10 px-4 lg:p-[60px]">
